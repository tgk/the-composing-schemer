...
(def scale-modes
  [major-scale harmonic-minor-scale natural-minor-scale
   locrian-mode mixolydian-mode])
 ...
 (rand-nth
  (l/run 1024 [melody2]
         (l/fresh [melody
                  ...
                  (l/membero scale-type scale-modes)
...
;; Given a tune that obey those rules, we can find the scale
(l/run* [scale-type]
         (l/fresh [melody
                   m1 m2 m3 m4 m5 m6 m7 m8
                   scale
                  ...
                  (scaleo base-note major-scale scale)
                  (l/permuteo scale melody)))
;; This returns all five scales - does that mean my music could be
;; generated by any of them?
